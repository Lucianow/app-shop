...
@section('title' , 'Editar Produtos App-Shop')
...
@section('content')
    ...
    <div class="main main-raised">
        <div class="container">
            ...
            <div class="section">
                <h2 class="title">Editar Produtos</h2>
                ...
                <form action="{{ url('/admin/products/'.$product->id.'/edit') }}" method="post">
                    ...
                    <textarea class="form-control" placeholder="Descrição detalhada do produto" rows="5" name="long_description">{{ old('long_description', $product->long_description) }}</textarea>
